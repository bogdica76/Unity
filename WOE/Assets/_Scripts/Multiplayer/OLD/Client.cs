    ...
    private void OnIncomingData(string data)
    {
        ...
        switch (aData[0])
        {
            ...
            case "Authenticated":
                ...
                break;
		case "UnitSpawned":
			//aici face serverul broadcast cand se logheaza un player nou.
			//ar trebui sa spawnez noul prefab nu asta vechi.
			GameObject prefab = PlayerPrefab;//Resources.Load("_Prefabs/TestPlayer") as GameObject;
            ...
            case "Synchronizing":
                ...
                for (int i = 0; i < numberOfUnitsOnServersMap; i++)
                {
                    ...
                    {
					prefab = OtherPrefab;//Resources.Load("Prefabs/Unit1") as GameObject;
